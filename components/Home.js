...
import design from 'react-svg-loader!../static/img/pantone.svg';
import code from 'react-svg-loader!../static/img/programming.svg';
import seo from 'react-svg-loader!../static/img/analysis.svg';
                ...
                <section className="home__intro">
                    ...
                    <div className="home__me">
                        ...
                        <div className="home__buttons">
                            <a className="button" href={cvHref} target="_blank" rel="noopener noreferrer" title="Download CV">Download CV</a>
                        </div>
                    </div>
                </section>
